...
# 📘טקסט – מחרוזות – Strings - STR

## ✨ הסבר
מחרוזת היא כל דבר שכתוב עם אותיות, מילים, תווים, מספרים או אפילו רווח או כל דבר שנמצא בין גרשיים.

בפייתון כל דבר בתוך גרשיים הוא טקסט, וככה המחשב יודע להבדיל שזה טקסט ולא נגיד מספר.

- אנחנו נשתמש בפונקציות של טקסט, שישנו(שיעדכנו) את הטקסט הקיים הנשמר בתוך שם משתנה שערך שלו מסוג של טקסט 
...
### אורך מחרוזת - כמה תווים יש במחרוזת
```python
text = "I love python"
print(len(text))  # 13
```
