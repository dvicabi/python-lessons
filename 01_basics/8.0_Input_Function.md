...
היא פונקציה שמאפשרת לקבל קלט מהמשתמש

כלומר שהמשתמש יקליד ערך, ואנחנו נוכל להשתמש בו בתוך הקוד

הפונקציה תמיד מחזירה קלט **מסוג של מחרוזת** – גם אם המשתמש מקליד מספר, אלא אם כן המרנו לסוג אחר

ניתן לשים בתוך אינפוט טקסט, כדי להציג שאלה או בקשה להמשתמש
